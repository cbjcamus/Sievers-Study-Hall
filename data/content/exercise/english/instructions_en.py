...
INSTRUCTION_EXERCISE_EN = {
    ...
    trennbare_verben: {
        ...
        23: "Translate the following (un)trennbare verb based on the specified root verb:",
        24: "Translate the following (un)trennbare verb based on the specified root verb:",
        ...
        27: "Translate the following (un)trennbare verb based on the specified prefix:",
        28: "Translate the following (un)trennbare verb based on the specified prefix:",
        29: "Translate the following (un)trennbare verb based on the specified prefix:",
        30: "Translate the following (un)trennbare verb based on the specified prefix:",
        31: "Translate the following (un)trennbare verb:",
        32: "Translate the following (un)trennbare verb:",
        33: "Translate the following (un)trennbare verb:",
        34: "Translate the following (un)trennbare verb:",
        35: "Translate the following (un)trennbare verb:",
        36: "Translate the following (un)trennbare verb:",
        ...
        55: "Translate the following (un)trennbare verb based on the specified root verb:",
        56: "Translate the following (un)trennbare verb based on the specified root verb:",
        57: "Translate the following (un)trennbare verb based on the specified root verb:",
        58: "Translate the following (un)trennbare verb based on the specified root verb:",
        59: "Translate the following (un)trennbare verb based on the specified root verb:",
        60: "Translate the following (un)trennbare verb based on the specified root verb:",
        61: "Translate the following (un)trennbare verb based on the specified root verb:",
        62: "Translate the following (un)trennbare verb based on the specified root verb:",
        63: "Translate the following (un)trennbare verb based on the specified root verb:",
        64: "Translate the following (un)trennbare verb based on the specified root verb:",
        65: "Translate the following (un)trennbare verb based on the specified root verb:",
        66: "Translate the following (un)trennbare verb based on the specified root verb:",
        67: "Translate the following (un)trennbare verb based on the specified root verb:",
        68: "Translate the following (un)trennbare verb based on the specified root verb:",
        69: "Translate the following (un)trennbare verb based on the specified root verb:",
        70: "Translate the following (un)trennbare verb based on the specified prefix:",
        71: "Translate the following (un)trennbare verb based on the specified prefix:",
        72: "Translate the following (un)trennbare verb based on the specified prefix:",
        73: "Translate the following (un)trennbare verb based on the specified prefix:",
        74: "Translate the following (un)trennbare verb based on the specified prefix:",
        75: "Translate the following (un)trennbare verb based on the specified prefix:",
        76: "Translate the following (un)trennbare verb based on the specified prefix:",
        77: "Translate the following (un)trennbare verb based on the specified prefix:",
        78: "Translate the following (un)trennbare verb based on the specified prefix:",
        79: "Translate the following (un)trennbare verb based on the specified prefix:",
        80: "Translate the following (un)trennbare verb based on the specified prefix:",
        81: "Translate the following (un)trennbare verb based on the specified prefix:",
        82: "Translate the following (un)trennbare verb based on the specified prefix:",
        83: "Translate the following (un)trennbare verb based on the specified prefix:",
        84: "Translate the following (un)trennbare verb based on the specified prefix:",
        85: "Translate the following (un)trennbare verb based on the specified prefix:",
        86: "Translate the following (un)trennbare verb based on the specified prefix:",
        87: "Translate the following (un)trennbare verb:",
        88: "Translate the following (un)trennbare verb:",
        89: "Translate the following (un)trennbare verb:",
        90: "Translate the following (un)trennbare verb:",
        91: "Translate the following (un)trennbare verb:",
        92: "Translate the following (un)trennbare verb:",
        93: "Translate the following (un)trennbare verb:",
        94: "Translate the following (un)trennbare verb:",
        95: "Translate the following (un)trennbare verb:",
        96: "Translate the following (un)trennbare verb:",
        97: "Translate the following (un)trennbare verb:",
        98: "Translate the following (un)trennbare verb:",
        99: "Translate the following (un)trennbare verb:",
        100: "Translate the following (un)trennbare verb:",
        101: "Translate the following (un)trennbare verb:",
        102: "Translate the following (un)trennbare verb:",
        103: "Translate the following (un)trennbare verb:",
    },
