...
INTRODUCTION = {
    ...
    pronomen:
        ...
        "<br><br>Not genitive though, there are no genitive pronoun in German. Latin does have genitive pronoun,"
        " why not german?"
        "<br><br>Includes reflexive, relative, relentless, reliable, and resolute pronouns.",
    konnektoren:
        "Connectors include conjunctions, subjunctions, and adverbs that connect two sentences together."
        ...
        "<br> &nbsp; &nbsp; &nbsp; &nbsp; &bull; Adverb: &nbsp; &nbsp; &nbsp; &nbsp; Adverb – Verb – Subjekt – "
        "Objektkomplement"
