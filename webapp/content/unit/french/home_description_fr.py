...
HOME_DESCRIPTION_FR = {
    praepositionen_grammatik: "Prépositions Allemandes dans tous les contextes",
    praepositionen_verben: "Paires Verbe–Préposition",
    praepositionen_adjektive: "Paires Adjectif–Préposition",
    ...
    praeteritum: "Préterit.",
    praeteritum_partizip_II: "Participe Passé & Préterit côte-à-côte.",
    imperativ: "Impératif",
    konjunktiv_II: "Subjonctif II",
