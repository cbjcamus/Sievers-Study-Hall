...
FEEDBACK = {
    ...
    praepositionen_verben: {
        ...
        22: "{german}"
            "<br><br><i>{english}</i>"
            "<br><br>Correct answer(s): {correct_answers}",
        23: "{english} = {german} + {case}",
        24: "{german}"
            "<br><br><i>{english}</i>"
            "<br><br>Correct answer(s): {correct_answers}",
        25: "{english} = {german} + {case}",
        26: "{german}"
            "<br><br><i>{english}</i>"
            "<br><br>Correct answer(s): {correct_answers}",

        27: "{english} = {german} + {case}",
        28: "{german}"
            "<br><br><i>{english}</i>"
            "<br><br>Correct answer(s): {correct_answers}",
        29: "{english} = {german} + {case}",
        30: "{german}"
            "<br><br><i>{english}</i>"
            "<br><br>Correct answer(s): {correct_answers}",
        31: "{english} = {german} + {case}",
        32: "{german}"
            "<br><br><i>{english}</i>"
            "<br><br>Correct answer(s): {correct_answers}",
        33: "{english} = {german} + {case}",
        34: "{german}"
            "<br><br><i>{english}</i>"
            "<br><br>Correct answer(s): {correct_answers}",
    },
    ...
    praepositionen_artikel: {
        1: "{german}"
            "<br><br><i>{english}</i>"
            "<br><br>{case}, {gender} → {correct_answers}",
        2: "{german}"
           "<br><br><i>{english}</i>"
           "<br><br>{case}, {gender} → {correct_answers}",
        3: "{german}"
