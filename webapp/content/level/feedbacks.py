...
FEEDBACK = {
    ...
    artikel: {
        ...
        18: "{german}"
            "<br><br><i>{english}</i>"
            "<br><br>{gender}, {case} → {correct_answers}",
        19: "{previous_question}, {gender}, {case} → {correct_answers}",
        20: "{german}"
            "<br><br><i>{english}</i>"
            "<br><br>{gender}, {case} → {correct_answers}",
        21: "{german}"
        ...
        25: "{previous_question}, {gender}, {case} → {correct_answers}",
        26: "{german}"
            "<br><br><i>{english}</i>"
            "<br><br>{gender}, {case} → {correct_answers}",
        27: "{gender}, {case} → {correct_answers}",
        28: "{german}"
            "<br><br><i>{english}</i>"
            "<br><br>{gender}, {case} → {correct_answers}",
        29: "{previous_question}, {gender}, {case} → {correct_answers}",
        30: "{german}"
            "<br><br><i>{english}</i>"
            "<br><br>{gender}, {case} → {correct_answers}",
