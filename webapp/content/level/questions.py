...
QUESTION = {
    ...
    artikel: {
        ...
        14: "{question}"
            "<br><br><i>{english}</i>",
        15: "{question} \u25CF {gender}, {case}",
        16: "{question}"
            "<br><br><i>{english}</i>",
        17: "{question} \u25CF {gender}, {case}",
        18: "{question}"
            "<br><br><i>{english}</i>",
        19: "{question} \u25CF {gender}, {case}",
        20: "{question}"
            "<br><br><i>{english}</i>",
        21: "{question}"
            "<br><br><i>{english}</i>",
        ...
        24: "{question}"
            "<br><br><i>{english}</i>",
        25: "{question} \u25CF {gender}, {case}",
        26: "{question}"
            "<br><br><i>{english}</i>",
        27: "{question} \u25CF {gender}, {case}",
        28: "{question}"
            "<br><br><i>{english}</i>",
        29: "{question} \u25CF {gender}, {case}",
        30: "{question}"
            "<br><br><i>{english}</i>",
        31: "{question}",
        32: "{question}"
    ...
    partizip_I: {
        1: "{question} \u25CF English: {english}",
        2: "{question} \u25CF English: {english}",
        3: "{question} \u25CF English: {english}",
    },
