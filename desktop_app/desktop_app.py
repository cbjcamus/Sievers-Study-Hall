...
from desktop_app.interface.style import size_window

from menus.startpage import StartPage

from menus.artikel.artikel import (Artikel, ArtikelLevel1, ArtikelLevel2, ArtikelLevel3, ArtikelLevel4, ArtikelLevel5,
                                   ArtikelLevel6, ArtikelLevel7, ArtikelLevel8, ArtikelLevel10, ArtikelLevel11,
                                   ArtikelLevel12, ArtikelLevel13)

from menus.pronomen.pronomen import (Pronomen, PronomenLevel1, PronomenLevel2, PronomenLevel3, PronomenLevel4,
...
from menus.konnektoren.konnektoren import (Konnektoren, KonnektorenLevel1, KonnektorenLevel2, KonnektorenLevel3,
                                           KonnektorenLevel4, KonnektorenLevel5, KonnektorenLevel6, KonnektorenLevel7,
                                           KonnektorenLevel8)

from menus.adjektivdeklinationen.adjektivdeklinationen import (Adjektivdeklinationen, AdjektivdeklinationenLevel1,
...
from menus.relativsaetze.relativsaetze import (Relativsaetze, RelativsaetzeLevel1, RelativsaetzeLevel2,
                                               RelativsaetzeLevel3, RelativsaetzeLevel4, RelativsaetzeLevel5,
                                               RelativsaetzeLevel6, RelativsaetzeLevel7)

from menus.praesens.praesens import (Praesens, PraesensLevel1, PraesensLevel2, PraesensLevel3, PraesensLevel4,
...
from menus.imperativ.imperativ import (Imperativ, ImperativLevel1, ImperativLevel2, ImperativLevel3, ImperativLevel4,
                                       ImperativLevel5)

from menus.perfekt.perfekt import (Perfekt, PerfektLevel1, PerfektLevel2, PerfektLevel3, PerfektLevel4, PerfektLevel5,
                                   PerfektLevel6, PerfektLevel7, PerfektLevel8)

from menus.praeteritum.praeteritum import (Praeteritum, PraeteritumLevel1, PraeteritumLevel2, PraeteritumLevel3,
                                           PraeteritumLevel4, PraeteritumLevel5)

from menus.konjunktiv.konjunktiv import Konjunktiv, KonjunktivLevel1

from menus.verben.verben import (Verben, VerbenLevel1, VerbenLevel2, VerbenLevel3, VerbenLevel4, VerbenLevel5,
                                 VerbenLevel6, VerbenLevel7, VerbenLevel8)

from menus.adjektive.adjektive import (Adjektive, AdjektiveLevel1)

from menus.adverbien.adverbien import (Adverbien, AdverbienLevel1, AdverbienLevel2, AdverbienLevel3, AdverbienLevel4,
