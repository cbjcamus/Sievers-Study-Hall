...
SCORE_PATH = f"{SCORE_PATH[adjektivDeklinationen]}/level16.csv"


class AdjektivdeklinationenLevel16(tk.Frame):
    ...
    def get_new_question(self):
        if not self.data.empty:
            ...
            question = (f"Complete the sentence with the correct form of the adjektiv "
                        f"\"{self.current_question['adjectiv']}\":"
            f"\n\n{self.current_question['question']} {bullet} {self.current_question['case']}")
