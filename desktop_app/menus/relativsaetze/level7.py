...
DATA_PATH = DATA_PATH[relativSaetze]
SCORE_PATH = f"{SCORE_PATH[relativSaetze]}/level7.csv"


class RelativsaetzeLevel7(tk.Frame):
    def __init__(self, parent, controller):
        ...
        create_button_back(self, "Back to Relativsätze",
                           lambda: controller.show_frame(Relativsaetze))
    ...
    def check_answer(self):
        ...
        correct_answer = [self.current_question["answer"].strip(), self.current_question["answer_2"]]
        ...
        if is_equal(user_answer, correct_answer, self.exercise):
            ...
            text = (f"{self.current_question['sentence']}"
                    f"\n\nor"
                    f"\n\n{self.current_question['sentence_2']}")
