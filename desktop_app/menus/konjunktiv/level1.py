...
DATA_PATH = DATA_PATH[konjunktiv]
SCORE_PATH = f"{SCORE_PATH[konjunktiv]}/level1.csv"

class KonjunktivLevel1(tk.Frame):
    def __init__(self, parent, controller):
        ...
        create_button_back(self, "Back to Konjunktiv",
                           lambda: controller.show_frame(Konjunktiv))
    ...
    def get_new_question(self):
        if not self.data.empty:
            ...
            question = (f"Find the present tense of the following verb:"
    ...
    def check_answer(self):
        ...
        correct_answer = self.current_question['konjunktiv'].strip()
        ...
        if is_equal(user_answer, correct_answer, self.exercise):
            ...
            text = (f"{self.current_question['german']} → "
                    f"{self.current_question['person']} {self.current_question['konjunktiv']}")
