...
DATA_PATH = DATA_PATH[praeteritum]
SCORE_PATH = f"{SCORE_PATH[praeteritum]}/level1.csv"


class PraeteritumLevel1(tk.Frame):
    def __init__(self, parent, controller):
        ...
        create_button_back(self, "Back to Präsens",
                           lambda: controller.show_frame(Praeteritum))
    ...
    def prepare_dataframe(self):
        ...
        for index, row in self.data.iterrows():
            for person in persons:
                ...
                new_row['praeteritum'] = row[person]
    ...
    def check_answer(self):
        ...
        correct_answer = self.current_question['praeteritum'].strip()
        ...
        if is_equal(user_answer, correct_answer, self.exercise):
            ...
            text = (f"{self.current_question['german']} → "
                    f"{self.current_question['person']} {self.current_question['praeteritum']}")
