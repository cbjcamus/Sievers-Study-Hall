...
from desktop_app.interface.widgets import (create_title, create_button_back, create_subtitle,
...
DATA_PATH = DATA_PATH[konnektoren]
SCORE_PATH = f"{SCORE_PATH[konnektoren]}/level6.csv"


class KonnektorenLevel6(tk.Frame):
    def __init__(self, parent, controller):
        ...
        create_button_back(self, "Back to Konnektoren",
                           lambda: controller.show_frame(Konnektoren))
    ...
    def get_new_question(self):
        if not self.data.empty:
            ...
            question = (f"Find the missing connector in the sentence:"
