...
from utils.normalization import is_equal, get_answers
...
SCORE_PATH = f"{SCORE_PATH[konnektoren]}/level3.csv"


class KonnektorenLevel3(tk.Frame):
    ...
    def get_new_question(self):
        if not self.data.empty:
            ...
            question = (f"Find the translation of the following connector:"
    ...
    def check_answer(self):
        ...
        if is_equal(user_answer, correct_answer, self.exercise):
            ...
            text = f"{self.current_question['english']} = {get_answers(correct_answer, konnektoren)}"
