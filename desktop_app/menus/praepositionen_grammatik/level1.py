...
SCORE_PATH = f"{SCORE_PATH[praepositionen_grammatik]}/level1.csv"


class PraepositionenGrammatikLevel1(tk.Frame):
    ...
    def get_new_question(self):
        if not self.data.empty:
            ...
            question = (f"Find the translation of the following präposition:"
