...
DATA_PATH = DATA_PATH[praesens]
SCORE_PATH = f"{SCORE_PATH[praesens]}/level10.csv"

class PraesensLevel10(tk.Frame):
    def __init__(self, parent, controller):
        ...
        create_button_back(self, "Back to Präsens",
                           lambda: controller.show_frame(Praesens))
    ...
    def check_answer(self):
        ...
        correct_answer = self.current_question['praesens'].strip()
        ...
        if is_equal(user_answer, correct_answer, self.exercise):
            ...
            text = (f"{self.current_question['german']} → "
                    f"{self.current_question['person']} {self.current_question['praesens']}")
