...
SCORE_PATH = f"{SCORE_PATH[adverbien]}/level7.csv"

class AdverbienLevel7(tk.Frame):
    ...
    def get_new_question(self):
        if not self.data.empty:
            ...
            question = (f"Find the translation of the following adverb:"
    ...
    def check_answer(self):
        ...
        if is_equal(user_answer, correct_answer, self.exercise):
            ...
            text = f"{self.current_question['english']} = {self.current_question['german']}"
