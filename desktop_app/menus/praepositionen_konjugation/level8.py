...
SCORE_PATH = f"{SCORE_PATH[praepositionen_konjugation]}/level8.csv"


class PraepositionenKonjugationLevel8(tk.Frame):
    ...
    def get_new_question(self):
        if not self.data.empty:
            ...
            question = (f"Find the question word that fits in the following sentence:"
