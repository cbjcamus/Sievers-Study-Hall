...
SCORE_PATH = f"{SCORE_PATH[praepositionen_konjugation]}/level9.csv"


class PraepositionenKonjugationLevel9(tk.Frame):
    ...
    def get_new_question(self):
        if not self.data.empty:
            ...
            question = (f"Find the präposition that match the following verb:"
