...
SCORE_PATH = f"{SCORE_PATH[praepositionen_konjugation]}/level7.csv"


class PraepositionenKonjugationLevel7(tk.Frame):
    ...
    def get_new_question(self):
        if not self.data.empty:
            ...
            question = (f"Find the Da-wort that fits in the following sentence:"
