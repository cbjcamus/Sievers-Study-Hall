...
DATA_PATH = DATA_PATH[artikel]
SCORE_PATH = f"{SCORE_PATH[artikel]}/level13.csv"


class ArtikelLevel13(tk.Frame):
    def __init__(self, parent, controller):
        ...
        create_button_back(self, "Back to Artikel",
                           lambda: controller.show_frame(Artikel))
    ...
    def get_new_question(self):
        if not self.data.empty:
            ...
            question = (f"Find the missing artikel in the sentence:"
