...
SCORE_PATH = f"{SCORE_PATH[artikel]}/level6.csv"


class ArtikelLevel6(tk.Frame):
    ...
    def get_new_question(self):
        if not self.data.empty:
            ...
            question = (f"Find the indefinite article that fits in the following sentence:"
                        f"\n\n{self.current_question['question']} {bullet} {self.current_question['gender']}")
