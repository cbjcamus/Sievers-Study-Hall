...
SCORE_PATH = f"{SCORE_PATH[perfekt]}/level2.csv"


class PerfektLevel2(tk.Frame):
    ...
    def get_new_question(self):
        if not self.data.empty:
            ...
            question = (f"Complete the sentence with the proper Partizip II:"
                        f"\n\n{self.current_question['question']} {bullet} {self.current_question['german']}"
    ...
    def check_answer(self):
        ...
        if is_equal(user_answer, correct_answer, self.exercise):
            ...
            text = (f"{self.current_question['german_sentence']}"
                    f"\n\n{self.current_question['english']}")
