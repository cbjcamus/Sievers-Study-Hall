...
DATA_PATH = DATA_PATH[adjektive]
SCORE_PATH = f"{SCORE_PATH[adjektive]}/level1.csv"


class AdjektiveLevel1(tk.Frame):
    def __init__(self, parent, controller):
        ...
        create_button_back(self, "Back to Adjektive",
                           lambda: controller.show_frame(Adjektive))
    ...
    def get_new_question(self):
        if not self.data.empty:
            ...
            question = (f"Find the translation of the following adjective:"
    ...
    def check_answer(self):
        ...
        if is_equal(user_answer, correct_answer, self.exercise):
            ...
            text = f"{self.current_question['english']} = {get_answers(correct_answer, adjektive)}"
