...
DATA_PATH = DATA_PATH[pronomen]
SCORE_PATH = f"{SCORE_PATH[pronomen]}/level5.csv"


class PronomenLevel5(tk.Frame):
    def __init__(self, parent, controller):
        ...
        create_button_back(self, "Back to Pronomen",
                           lambda: controller.show_frame(Pronomen))
    ...
    def get_new_question(self):
        if not self.data.empty:
            ...
            question = (f"Complete the sentence with the correct pronoun:"
            f"\n\n{self.current_question['question']} {bullet} {self.current_question['person']}")
